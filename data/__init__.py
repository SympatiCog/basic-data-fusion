"""
Data processing module for Basic Data Fusion.

This module provides data processing functionality including merge strategies,
metadata extraction, data validation, and export capabilities.
"""
