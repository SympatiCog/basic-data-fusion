...
app.layout = dbc.Container([
    ...
    dcc.Store(id='phenotypic-add-button-clicks-store', storage_type='local', data=0),
    dcc.Store(id='phenotypic-filter-render-trigger-store', storage_type='session', data=0),
