...
# DISABLED: This file conflicts with pages/query.py 
# Both files were registering the same page path and callbacks, causing conflicts
...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            ...
            html.Div(
                id='merge-strategy-info',
                children=[
                    dbc.Alert([
                        html.Div([
                            dbc.Spinner(size="sm"),
                            html.Span("Working on your data. Just a few seconds...", className="ms-2")
    ...
    dbc.Row([
        dbc.Col([
            ...
            html.Div(
                id='live-participant-count',
                children=[
                    dbc.Alert([
                        html.Div([
                            dbc.Spinner(size="sm"),
                            html.Span("Loading participant count...", className="ms-2")
                        ], className="d-flex align-items-center")
                    ], color="secondary")
                ]
